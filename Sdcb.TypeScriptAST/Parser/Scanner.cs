...
namespace Sdcb.TypeScript.TsParser
{
    ...
    public class Scanner
    {
        ...
        public Scanner(ScriptTarget languageVersion, bool skipTrivia, LanguageVariant languageVariant, string text, ErrorCallback _ = null, int start = 0, int? length = null)
        {
...
{ "@", SyntaxKind.AtToken },
        ...
        public static U IterateCommentRanges<T, U>(bool reduce, string text, int pos, bool trailing, Func<(int pos, int end, CommentKind kind, bool hasTrailingNewLine, T state, U memo), U> cb, T state, U initial = default)
        {
            int pendingPos = 0;
            int pendingEnd = 0;
